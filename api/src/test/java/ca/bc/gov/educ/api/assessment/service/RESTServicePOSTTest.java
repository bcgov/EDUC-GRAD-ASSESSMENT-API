...
public class RESTServicePOSTTest {
    ...
    @Before
    public void setUp(){
        Mockito.reset(assessmentApiWebClient, responseMock, requestHeadersMock, requestBodyMock, requestBodyUriMock);
        ThreadLocalStateUtil.clear();
        when(this.assessmentApiWebClient.post()).thenReturn(this.requestBodyUriMock);
